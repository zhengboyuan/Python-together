...
if __name__ == "__main__":
    ...
    page = st_navbar(["虚拟电厂投资测算", "储能投资测算", "黄冈接口数据查询"])
    if page == "储能投资测算":
        st.switch_page("pages/Storage_Scale_CalculationV1.py")
    if page == "黄冈接口数据查询":
        st.switch_page("pages/查询数据接口V1.py")
    # 定义页面字典 
    # pages = {
    #     "主页": [
    #         # # st.Page("vpp_investment0730v2.py",  title="虚拟电厂投资测算"),
    #         # # st.Page("查询数据接口V1.py",  title="查询数据接口"),
    #         st.Page(Storage_Scale_CalculationV1,  title="储能投资规模测算"),
    #     ]
    # }
