        ...
        with usrer_investment_empty:
            ...
            with container1_col:
                ...
                with container1:
                    ...
                    hard_ware = container1.number_input("硬件后续每年投资", min_value=0,value=0, step=1)
                ...
                try:
                    break_even_index = total_revenue[total_revenue['虚拟电厂总收益(万元/年)累计'] > total_revenue['投资金额累计']].idxmin().values.min()
                except ValueError:
