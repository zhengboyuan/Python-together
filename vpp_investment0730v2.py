...
# 绘制饼图
    ...
    soft_ware_investment = col_soft.number_input("软件投资(万元)", min_value=0,value=0, step=10,help='首年软件投资')
    hard_ware_first = col_hard_ware_first.number_input("硬件首年投资", min_value=0,value=0, step=1)
    hard_ware = col_hard_ware.number_input("硬件后续每年投资", min_value=0,value=0, step=1)
    ...
    st.markdown('**用户虚拟电厂10年累计投资、收益分布（万元/年）**')
    #st.bar_chart(total_revenue,y=["投资金额累计", "虚拟电厂总收益(万元/年)累计"],color=["#FF0000", "#0000FF"] )
    # 假设数据
    # 假设数据
